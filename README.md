...
1. Open the GitHub page of this repository and click the green [Code] button.
2. Click the clipboard icon 📋 next to the HTTPS URL to copy it.
3. Open a terminal (or command prompt) at your preferred location.\
4. Clone the repository using the command below (replace <`URL`> with the copied URL). If you want to save it on your Desktop, for example:
